...
export const ABI = [
  ...
  'function getListingRentalIds(uint256 listingId) view returns (uint256[])',
  ...
  'function datesAvailable(uint256 listingId,uint64 startTime,uint64 endTime) view returns (bool)',
  ...
  'function acceptRental(uint256 rentalId)',
  'function startRental(uint256 rentalId)',
  'function completeRental(uint256 rentalId)',
  'function cancelBeforeStart(uint256 rentalId)',
  'function ownerCancelBeforeStart(uint256 rentalId)',
  'function refundUnaccepted(uint256 rentalId)',
  'function withdraw()',
